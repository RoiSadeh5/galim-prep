 ...
 *  יובאו מ-waves-prep (הניסיון המקביל) ואוחדו לכאן.
 *  הקטגוריות מומפו למפתחות topicPages שב-config.js.
 * ============================================================ */
...
window.CODEX_ADAPTIVE_QUESTIONS = (window.CODEX_ADAPTIVE_QUESTIONS || []).concat([
  {
    ...
    kind: "math",
    opts: [{h:"6 m/s",ltr:true},{h:"30 m/s",ltr:true},{h:"90 m/s",ltr:true},{h:"900 m/s",ltr:true}],
    ans: 1,
    rule: "במיתר: v = √(T/ρ).",
  ...
  },
  {
    ...
    kind: "math",
    opts: [{h:"6 kg/s",ltr:true},{h:"30 kg/s",ltr:true},{h:"36 kg/s",ltr:true},{h:"90 kg/s",ltr:true}],
    ans: 0,
  ...
  },
  {
    ...
    kind: "math",
    opts: [{h:"30 m/s",ltr:true},{h:"90 m/s",ltr:true},{h:"94.87 m/s",ltr:true},{h:"9000 m/s",ltr:true}],
    ans: 2,
  ...
  },
  {
    ...
    kind: "math",
    opts: [{h:"K₀=3.6 J, U₀=3.6 J",ltr:true},{h:"K₀=4.8 J, U₀=2.4 J",ltr:true},{h:"K₀=2.4 J, U₀=4.8 J",ltr:true},{h:"K₀=7.2 J, U₀=3.6 J",ltr:true}],
    ans: 1,
  ...
  },
  {
    ...
    kind: "math",
    opts: [{h:"τ=2/3, R=−1/3",ltr:true},{h:"τ=4/3, R=1/3",ltr:true},{h:"τ=1/3, R=2/3",ltr:true},{h:"τ=8/9, R=1/9",ltr:true}],
    ans: 0,
  ...
  },
  {
    ...
    kind: "math",
    opts: [{h:"1/3 מוחזר, 2/3 עובר",ltr:true},{h:"1/9 מוחזר, 8/9 עובר",ltr:true},{h:"2/3 מוחזר, 1/3 עובר",ltr:true},{h:"1/9 מוחזר, 2/3 עובר",ltr:true}],
    ans: 1,
  ...
  },
  {
    ...
    kind: "math",
    opts: [{h:"ωₙ=25πn rad/s",ltr:true},{h:"ωₙ=50πn rad/s",ltr:true},{h:"ωₙ=150πn rad/s",ltr:true},{h:"ωₙ=900πn rad/s",ltr:true}],
    ans: 0,
  ...
  },
  {
    ...
    kind: "math",
    opts: [{h:"0.02 s",ltr:true},{h:"0.04 s",ltr:true},{h:"0.08 s",ltr:true},{h:"25 s",ltr:true}],
    ans: 2,
  ...
  },
  {
    ...
    kind: "math",
    opts: [{h:"v=1/√(LC), Z=√(L/C)",ltr:true},{h:"v=√(L/C), Z=1/√(LC)",ltr:true},{h:"v=LC, Z=L/C",ltr:true},{h:"v=√(LC), Z=√(C/L)",ltr:true}],
    ans: 0,
  ...
  },
  {
    ...
    kind: "math",
    opts: [{h:"Pᴅ=Zvᵧ²",ltr:true},{h:"Pᴅ=Z²vᵧ",ltr:true},{h:"Pᴅ=vᵧ/Z",ltr:true},{h:"Pᴅ=T/Z",ltr:true}],
    ans: 0,
